 ...
 {/* <div className="client text-center">
  ...
  <div className="container">
    <div className="row">
          ...
          <div className="carousel-inner">
            <div className="carousel-item active">
              <div className="client-review p-5">
                <img src="images/client-1.png" className="client-img" />
                <h5>Martin Jack</h5>
                <h6>From Hooli</h6>
            ...
            <div className="carousel-item">
              <div className="client-review p-5">
                <img src="images/client-2.png" className="client-img" />
                <h5>David Dowsy</h5>
                <h6>From Globex</h6>
                <i className="fas fa-quote-left" />
            ...
            <div className="carousel-item">
              <div className="client-review p-5">
                <img src="images/client-3.png" className="client-img" />
                <h5>Doglas Kosta</h5>
                <h6>From Soylent</h6>
                <i className="fas fa-quote-left" />
            ...
            <div className="carousel-item">
              <div className="client-review p-5">
                <img src="images/client-4.png" className="client-img" />
                <h5>Anthony Lee</h5>
                <h6>From Initech</h6>
                <i className="fas fa-quote-left" />
            ...
            <div className="carousel-item">
              <div className="client-review p-5">
                <img src="images/client-5.png" className="client-img" />
                <h5>Jane Doris</h5>
                <h6>From Acme</h6>
                <i className="fas fa-quote-left" />
            ...
            <div className="carousel-item">
              <div className="client-review p-5">
                <img src="images/client-6.png" className="client-img" />
                <h5>Jonathon Doe</h5>
                <h6>From Umbrella</h6>
                <i className="fas fa-quote-left" />
            ...
            <div className="carousel-item">
              <div className="client-review p-5">
                <img src="images/client-7.png" className="client-img" />
                <h5>Shane Catson</h5>
                <h6>From Massive</h6>
                <i className="fas fa-quote-left" />
            ...
            <div className="carousel-item">
              <div className="client-review p-5">
                <img src="images/client-8.png" className="client-img" />
                <h5>Hugh Tace</h5>
                <h6>From Capital</h6>
                <i className="fas fa-quote-left" />
            ...
            <div className="carousel-item">
              <div className="client-review p-5">
                <img src="images/client-9.png" className="client-img" />
                <h5>Chris Wort</h5>
                <h6>From Sylhost</h6>
                <i className="fas fa-quote-left" />
      ...
      <img src="images/client-1.png" class="client-img">
      <h5>Martin Jack</h5>
      <h6>From Hooli</h6>

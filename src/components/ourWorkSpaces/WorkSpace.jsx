            ...
            <div className="col-lg-3">
              <div className={`card ${styles.cards}`}>
                ...
                <div className="card-body">
                  ...
                  <Link to={"/Room/" + Room.id}>More Details </Link>
                </div>
            ...
            <div className="Review">
              <div className={`bar ${styles.bar}`}>
                <div className={`${styles.progressHeading}`}>
                  <p className={`${styles.progressTitle}`}>MARKETING</p>
                  <div className={`${styles.progressValue}`} style={{ width: '80%', opacity: 1 }}>80%</div>
                </div>
                <div className={`${styles.progress}`}>
                  <div className={`${styles.progBar}`} data-value={80} style={{ width: '80%' }} />
                </div>
              </div>

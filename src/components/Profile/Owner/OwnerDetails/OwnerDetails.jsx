  ...
  return (
      ...
      <div className={`${styles.inputSetting}`}>
        ...
        <div className="row mt-4">
          ...
          <Button  type="submit" className={`${styles.ProfileBtn}`} onClick={() => setIsOwnerEditMode(false)} id="button">
          Save
        </Button>
        </div>
        <div className="col-lg-4">
        <Button variant="secondary" type="submit" className={`border-black bg-secondary ${styles.ProfileBtn}`} onClick={() => setIsOwnerEditMode(false)} id="button" >
          Cancel
        </Button>
          </div>
        </div>

...
<form className={`${styles.form}`}>
  <div className={`${styles.paymentOptions}`}>
    ...
    <button className={`${styles.btnPay}`}  name="apple-pay" type="button">
    ...
    <button className={`${styles.btnPay}`}  name="google-pay" type="button">
  ...
  <div className={`${styles.creditInfo}`}>
    <div className={`${styles.inputContainer}`}>
      <label htmlFor="password_field" className={`${styles.inputLabel}`}>Card holder full name</label>
      <input id="password_field" className={`${styles.inputField}`} type="text" name="input-name" title="Inpit title" placeholder="Enter your full name" />
    </div>
    <div className={`${styles.inputContainer}`}>
      <label htmlFor="password_field" className={`${styles.inputLabel}`}>Card Number</label>
      <input id="password_field" className={`${styles.inputField}`} type="number" name="input-name" title="Inpit title" placeholder="0000 0000 0000 0000" />
    </div>
    <div className={`${styles.inputContainer}`}>
      <label htmlFor="password_field" className={`${styles.inputLabel}`}>Expiry Date / CVV</label>
      <div className={`${styles.split}`}>
        <input id="password_field" className={`${styles.inputField}`} type="text" name="input-name" title="Expiry Date" placeholder="01/23" />
        <input id="password_field" className={`${styles.inputField}`} type="number" name="cvv" title="CVV" placeholder="CVV" />
      </div>
    </div>
  </div>
